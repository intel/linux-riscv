					    ...
					    struct mpxy_opteed_resp *res)
{
	...
	rpmi_mbox_init_send_with_response(&msg, RPMI_MM_SRV_COMMUNICATE,
	...
	// pr_info("msg.out_response_len=0x%016lX\n", msg.data.out_response_len);
	// pr_info("a0=0x%016lX, a1=0x%016lX, a2=0x%016lX, a3=0x%016lX\n",
